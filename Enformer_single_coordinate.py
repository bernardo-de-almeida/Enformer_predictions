...
def main(argv):
   ...
   try:
      ...
      print('Run_Enformer_single_sequence.py -d <fasta seq file [GENOME or fasta of interest]> -s <species features [human/mouse]> -f <feature IDs from table indexes to get predictions for [0,23,809]> -i <interval [chr11:35082742-35197430, will be resized]> -o <output> -t <save full table of predictions [0/1]> -p <plot tracks [0/1]> -b <make bigwigs [0/1]>')
      sys.exit(2)
   for opt, arg in opts:
      if opt == '-h':
         print('Run_Enformer_single_sequence.py -d <fasta seq file [GENOME or fasta of interest]> -s <species features [human/mouse]> -f <feature IDs from table indexes to get predictions for [0,23,809]> -i <interval [chr11:35082742-35197430, will be resized]> -o <output> -t <save full table of predictions [0/1]> -p <plot tracks [0/1]> -b <make bigwigs [0/1]>')
...
if interval != 'NA':
   ...
   row_names = ['Bin' + str(i) for i in range(len(chr_list))]
